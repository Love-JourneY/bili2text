...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "opt_provider_help": "转写引擎: qwen3（本地 ONNX）/ volcengine（云端）。",
        "opt_model_help": "模型名称。",
        ...
        "doctor_sherpa": "sherpa-onnx",
        "doctor_qwen3_model": "Qwen3-ASR 模型",
        "doctor_vad": "Silero VAD",
        ...
        "bootstrap_qwen3_dir_prompt": "Qwen3-ASR 模型目录（需含 conv_frontend / encoder / decoder / tokenizer）",
        "bootstrap_qwen3_vad_prompt": "Silero VAD 模型路径（长音频切块用，约 2MB）",
        "bootstrap_qwen3_threads_prompt": "推理线程数",
        "bootstrap_qwen3_provider_prompt": "onnxruntime provider（cpu / cuda / coreml，需对应 build 才生效）",
        ...
        "provider_qwen3_short": "本地 ONNX 推理（Qwen3-ASR），不用 PyTorch，中文好",
        ...
        "provider_qwen3_name": "Qwen3-ASR 本地模型（ONNX）",
        "provider_qwen3_desc": "通过 sherpa-onnx 运行 ONNX 模型，不需要 PyTorch/CUDA。长音频自动用 Silero VAD 切块，输出自带分段。",
    ...
    "en-US": {
        ...
        "opt_provider_help": "Transcription engine: qwen3 (local ONNX) / volcengine (cloud).",
        ...
        "bootstrap_qwen3_dir_prompt": "Qwen3-ASR model directory (needs conv_frontend / encoder / decoder / tokenizer)",
        "bootstrap_qwen3_vad_prompt": "Silero VAD model path (for long-audio chunking, ~2MB)",
        "bootstrap_qwen3_threads_prompt": "Inference threads",
        "bootstrap_qwen3_provider_prompt": "onnxruntime provider (cpu / cuda / coreml — needs a matching build)",
        ...
        # ── Provider short descriptions (for select menu) ────
        "provider_qwen3_short": "Local ONNX inference (Qwen3-ASR), no PyTorch, strong Chinese",
        ...
        # ── Provider full descriptions ───────────────────────
        "provider_qwen3_name": "Qwen3-ASR (local, ONNX)",
        "provider_qwen3_desc": "Runs ONNX models through sherpa-onnx — no PyTorch/CUDA needed. Long audio is chunked by Silero VAD and the output carries per-segment timing.",
